...
namespace DataLayer.Migrations
{
    ...
    [Migration("20220301201942_migration_8_mig")]
    partial class migration_8_mig
    {
            ...
            modelBuilder.Entity("DataLayer.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 1, 23, 49, 42, 557, DateTimeKind.Local).AddTicks(788),
                        ...
                        new
                        {
                            ProductID = 2,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 1, 23, 49, 42, 560, DateTimeKind.Local).AddTicks(5431),
                        ...
                        new
                        {
                            ProductID = 3,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 1, 23, 49, 42, 560, DateTimeKind.Local).AddTicks(5515),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                            ImageName = "123awr.jpg",
                            IsAvailable = false,
                            Keywords = "کیف;کفش;کیف مردانه;چرم;چرم طبیعی;کیمیا مهر",
