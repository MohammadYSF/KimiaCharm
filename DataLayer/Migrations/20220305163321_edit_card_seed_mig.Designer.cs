...
namespace DataLayer.Migrations
{
    ...
    [Migration("20220305163321_edit_card_seed_mig")]
    partial class edit_card_seed_mig
    {
            ...
            modelBuilder.Entity("DataLayer.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 20, 3, 21, 482, DateTimeKind.Local).AddTicks(9750),
                        ...
                        new
                        {
                            ProductID = 2,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 5, 20, 3, 21, 485, DateTimeKind.Local).AddTicks(9105),
                        ...
                        new
                        {
                            ProductID = 3,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 20, 3, 21, 485, DateTimeKind.Local).AddTicks(9232),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 4,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 5, 20, 3, 21, 485, DateTimeKind.Local).AddTicks(9240),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 5,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 20, 3, 21, 485, DateTimeKind.Local).AddTicks(9244),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 6,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 20, 3, 21, 485, DateTimeKind.Local).AddTicks(9248),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 7,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 5, 20, 3, 21, 485, DateTimeKind.Local).AddTicks(9252),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 8,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 20, 3, 21, 485, DateTimeKind.Local).AddTicks(9256),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
