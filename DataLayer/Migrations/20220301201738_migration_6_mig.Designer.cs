...
namespace DataLayer.Migrations
{
    ...
    [Migration("20220301201738_migration_6_mig")]
    partial class migration_6_mig
    {
            ...
            modelBuilder.Entity("DataLayer.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 1, 23, 47, 38, 593, DateTimeKind.Local).AddTicks(919),
                        ...
                        new
                        {
                            ProductID = 2,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 1, 23, 47, 38, 595, DateTimeKind.Local).AddTicks(672),
                        ...
                        new
                        {
                            ProductID = 3,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 1, 23, 47, 38, 595, DateTimeKind.Local).AddTicks(744),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                            ImageName = "123awr.jpg",
                            IsAvailable = false,
                            Keywords = "کیف;کفش;کیف مردانه;چرم;چرم طبیعی;کیمیا مهر",
