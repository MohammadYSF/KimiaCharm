...
namespace DataLayer.Migrations
{
    ...
    [Migration("20220301201809_migration_7_mig")]
    partial class migration_7_mig
    {
            ...
            modelBuilder.Entity("DataLayer.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 1, 23, 48, 9, 683, DateTimeKind.Local).AddTicks(6676),
                        ...
                        new
                        {
                            ProductID = 2,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 1, 23, 48, 9, 686, DateTimeKind.Local).AddTicks(2582),
                        ...
                        new
                        {
                            ProductID = 3,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 1, 23, 48, 9, 686, DateTimeKind.Local).AddTicks(2658),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                            ImageName = "123awr.jpg",
                            IsAvailable = false,
                            Keywords = "کیف;کفش;کیف مردانه;چرم;چرم طبیعی;کیمیا مهر",
