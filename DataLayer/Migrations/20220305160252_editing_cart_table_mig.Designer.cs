...
namespace DataLayer.Migrations
{
    ...
    [Migration("20220305160252_editing_cart_table_mig")]
    partial class editing_cart_table_mig
    {
            ...
            modelBuilder.Entity("DataLayer.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductID = 1,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 19, 32, 52, 82, DateTimeKind.Local).AddTicks(5923),
                        ...
                        new
                        {
                            ProductID = 2,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 5, 19, 32, 52, 85, DateTimeKind.Local).AddTicks(649),
                        ...
                        new
                        {
                            ProductID = 3,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 19, 32, 52, 85, DateTimeKind.Local).AddTicks(732),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 4,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 5, 19, 32, 52, 85, DateTimeKind.Local).AddTicks(738),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 5,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 19, 32, 52, 85, DateTimeKind.Local).AddTicks(740),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 6,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 19, 32, 52, 85, DateTimeKind.Local).AddTicks(743),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 7,
                            CategoryID = 2,
                            Date = new DateTime(2022, 3, 5, 19, 32, 52, 85, DateTimeKind.Local).AddTicks(746),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
                        ...
                        new
                        {
                            ProductID = 8,
                            CategoryID = 1,
                            Date = new DateTime(2022, 3, 5, 19, 32, 52, 85, DateTimeKind.Local).AddTicks(751),
                            FullDescription = "کیف مردانه در رنگ های متنوع و ساخته شده با چرم مصنوعی با قیمتی باور نکردنی ",
